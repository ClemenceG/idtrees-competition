...
def evaluation_parameters(args):
    ...
    parser.add_argument('--outputfn', help='file name that output is saved to',default="task1",type=str)
    ...
    #Output parameters
    parser.add_argument('--save', help='plot the halos and ground truth boxes with the score and save in scores/imgs',  default=0, type=int)
